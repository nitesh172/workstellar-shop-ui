  ...
  return (
    <div className='py-7 md:py-14'>
      ...
      <div className="flex flex-col gap-12 md:gap-8">
        ...
        <div id='Testimonials' className="bg-bgbule w-full rounded-3xl p-6 md:p-12 flex flex-col xl:flex-row items-center gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-white p-6 rounded-xl flex flex-col gap-3.5">
                ...
                <div className="text-sm text-black">
                  ...
                  They listen, understand our needs, communicate well and are
                  constantly working to ensure our satisfaction at all stages of
                  the recruitment process.
                </div>
                <div className="flex flex-col gap-2">
                  <div className="text-xs font-medium">Rachel McDermott</div>
          ...
          <VideoFrame id='Why us' className='flex-1 w-full flex flex-col gap-0.5' />
        </div>
      </div>
    </div>
  )
